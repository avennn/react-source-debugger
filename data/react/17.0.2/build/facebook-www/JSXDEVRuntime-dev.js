...
function isValidElementType(type) {
  ...
  if (type === exports.Fragment || type === REACT_PROFILER_TYPE || type === REACT_DEBUG_TRACING_MODE_TYPE || type === REACT_STRICT_MODE_TYPE || type === REACT_SUSPENSE_TYPE || type === REACT_SUSPENSE_LIST_TYPE || type === REACT_LEGACY_HIDDEN_TYPE ||  type === REACT_SCOPE_TYPE) {
    return true;
  }
...
function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
  {
    ...
    if (warnAboutSpreadingKeyToJSX) {
      if (hasOwnProperty$1.call(props, 'key')) {
        error('React.jsx: Spreading a key to JSX is a deprecated pattern. ' + 'Explicitly pass a key after spreading props in your JSX call. ' + 'E.g. <%s {...props} key={key} />', getComponentName(type) || 'ComponentName');
      }
    }

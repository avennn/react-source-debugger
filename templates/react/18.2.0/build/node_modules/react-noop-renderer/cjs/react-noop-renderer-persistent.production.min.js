...
function createReactNoop(reconciler, useMutation) {
  ...
  const ReactNoop = {
    ...
    createRoot(options) {
      ...
      const fiberRoot = NoopRenderer.createContainer(container, constants.ConcurrentRoot, null, null, false, '', onRecoverableError, options && options.transitionCallbacks ? options.transitionCallbacks : null);
      return {
        _Scheduler: Scheduler,
    ...
    createLegacyRoot() {
      ...
      const fiberRoot = NoopRenderer.createContainer(container, constants.LegacyRoot, null, null, false, '', onRecoverableError);
      return {
        _Scheduler: Scheduler,
...
//# sourceMappingURL=react-noop-renderer-persistent.production.min.js.map

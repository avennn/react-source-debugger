(function (global, factory) {
  ...
  function renderToReadableStream(model, webpackMap, options) {
    const request = createRequest(model, webpackMap, options ? options.onError : undefined, options ? options.context : undefined, options ? options.identifierPrefix : undefined);
...
//# sourceMappingURL=react-server-dom-webpack-writer.browser.production.min.server.js.map

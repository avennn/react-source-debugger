...
function createResponse$1(bundlerConfig) {
  ...
  const response = createResponse(bundlerConfig);
  response._partialRow = '';
...
function createFromReadableStream(stream, options) {
  const response = createResponse$1(options && options.moduleMap ? options.moduleMap : null);
...
//# sourceMappingURL=react-server-dom-webpack.production.min.js.map
